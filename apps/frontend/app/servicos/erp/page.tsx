        ...
        <div className="relative mx-auto grid w-full max-w-6xl items-center gap-10 px-6 py-16 md:grid-cols-12">
          <div className="md:col-span-6">
            ...
            <h1 className="mt-6 text-4xl font-black leading-[1.05] tracking-tight sm:text-5xl">
              ...
              <span className="block text-accent-400">em um unico sistema.</span>
            </h1>
            <p className="mt-5 max-w-xl text-sm leading-7 text-zinc-300">
              Construimos ERP sob medida para sua rotina: processos, financeiro, estoque,
              producao e relatorios com previsibilidade.
            </p>
            ...
            <div className="mt-8 grid gap-3 text-sm text-zinc-200">
              <p className="font-black text-zinc-100">Modulos comuns:</p>
              <ul className="space-y-2 text-zinc-300">
                <li>Contas a pagar e a receber</li>
                <li>Estoque e producao</li>
