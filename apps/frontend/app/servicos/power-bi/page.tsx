        ...
        <div className="relative mx-auto grid w-full max-w-6xl items-center gap-10 px-6 py-16 md:grid-cols-12">
          <div className="md:col-span-6">
            ...
            <h1 className="mt-6 text-4xl font-black leading-[1.05] tracking-tight sm:text-5xl">
              Dashboards que viram
              <span className="block text-accent-400">decisao rapida.</span>
            </h1>
            <p className="mt-5 max-w-xl text-sm leading-7 text-zinc-300">
              Criamos indicadores claros para sua operacao: modelagem, DAX, visuais e
              relatorios com foco em gestao.
            </p>
            ...
            <div className="mt-8 grid gap-3 text-sm text-zinc-200">
              <p className="font-black text-zinc-100">Entrega tipica:</p>
              <ul className="space-y-2 text-zinc-300">
                <li>Modelagem e padronizacao dos dados</li>
                <li>Medidas DAX e KPI executivos</li>
                <li>Paineis para diretoria e operacao</li>
              </ul>
            </div>
          </div>
